...
function Shop() {
  ...
  return (
    <div className="w-full min-h-[700px] flex flex-col items-center px-4 sm:px-6 lg:px-12">
      <h3 className="text-[20px] text-left w-full max-w-6xl mb-6">
        Showing all {ProductData?.data?.length || 0} results
      </h3>
          ...
          return (
            <div key={item.id} className="box-wrapper w-[280px] sm:w-[300px]">
              <div className={`box relative ${isClicked ? "active-heart" : ""}`}>
                <CiHeart
                  className={`heart-icon absolute top-2 right-2 text-2xl z-10 cursor-pointer ${
              ...
              {isClicked && (
                <div className="amazon-msg animate-fade-in flex items-center justify-center gap-2">
