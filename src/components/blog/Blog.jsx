...
const Sidebar = ({ BlogData }) => (
  <div className="w-full lg:w-1/3 px-4">
    <h4 className="text-xl font-semibold text-gray-500 mb-4">Search</h4>
    <div className="flex mb-6">
      <input type="text" className="border border-black p-2 w-full focus:outline-none" placeholder="Search..." />
    ...
    <div className="relative w-full mt-8">
      <input type="text"
        ...
        placeholder="Search..."/>
      <IoIosSearch className="absolute right-4 top-1/2 transform -translate-y-1/2 text-xl" />
    </div>
  </div>
)
